...
<center style="border: 2px solid #4CAF50; padding: 10px; border-radius: 5px;">
  ...
  This article has gathered over <strong>8K reads</strong> on <a href="https://dev.to/ayoub3bidi/quick-tutorial-how-to-add-a-release-github-workflow-56ib">DEV</a>.<br/>
